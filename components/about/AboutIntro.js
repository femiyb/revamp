    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 space-y-6">
          <h2 className="text-3xl font-bold text-tealCustom4">
            A Little About Me
          </h2>
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            support, and customer care, I thrive on solving complex problems and
            collaborating with teams to deliver high-quality solutions.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed">
            When I’m not coding, you’ll find me sharing insights on WordPress
            and accessibility on my blog, speaking at tech conferences, and
            organizing WordPress community events.
          </p>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center mt-8 md:mt-0">
          <img
            src="https://app.femiyb.me/wp-content/uploads/2022/01/hoodie_samuel-femi-taiwo-332x1024.png"
            alt="Femi Avatar"
